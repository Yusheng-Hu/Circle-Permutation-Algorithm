/**
 * @file    ppa_rcpa.cpp
 * @brief   High-Performance Permutation Generator using Position-Pure-Algorithm  and Ring-Cascade-Permutation-Algorithm.
 * @author  YUSHENG-HU
 * @date    2026-01-29
 * @details
 * This implementation achieves ultra-high throughput (~16 Giga-perms/sec) by 
 * combining a Non-recursive Plain Changes (PP) generator with a Ring-Cascade burst logic. 
 * * Key optimizations:
